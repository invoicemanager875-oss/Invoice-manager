...
use App\Http\Controllers\JadwalPerencanaanController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('jadwal-perencanaan', JadwalPerencanaanController::class);
    Route::patch('jadwal-perencanaan/{jadwal_perencanaan}/publish', [JadwalPerencanaanController::class, 'publish'])->name('jadwal-perencanaan.publish');
    Route::get('jadwal-perencanaan/{jadwal_perencanaan}/pdf', [JadwalPerencanaanController::class, 'pdf'])->name('jadwal-perencanaan.pdf');
    Route::get('schedules', [JadwalPerencanaanController::class, 'index'])->name('schedules.index');

    Route::resource('contracts', ContractController::class);
    Route::patch('contracts/{contract}/finalize', [ContractController::class, 'finalize'])->name('contracts.finalize');
    Route::get('contracts/{contract}/pdf', [ContractController::class, 'pdf'])->name('contracts.pdf');
    Route::post('contracts/auto-narasi', [ContractController::class, 'generateNarasiAjax'])->name('contracts.autoNarasi');
    Route::get('surat-kontrak', [ContractController::class, 'index'])->name('surat-kontrak.index');
