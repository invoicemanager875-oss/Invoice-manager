...
class DashboardController extends Controller
{
     ...
     */
    private function projectStats(bool $isSuperAdmin, Collection $brandIds): array
    {
     ...
     */
    private function draftersStatus(bool $isSuperAdmin, Collection $brandIds): Collection
    {
        $brandIds = $brandIds->all();
